  ...
  <q-page padding>
    ...
    <q-card flat bordered class="q-mt-md">
        ...
        <div class="row q-mb-md bg-grey-2 q-pa-md ">
          <div class="col-2">
            <div class="row">
              ...
              <div class="col-8">
                <q-radio class="q-ml-sm q-mb-sm" dense color="blue-grey-9"
                         v-model="managerVariety" val="instructor" label="강사"/>
                <q-radio class="q-ml-sm" dense color="blue-grey-9"
                         v-model="managerVariety" val="manager" label="매니저"/>
              </div>
            </div>
          </div>
          ...
          <div class="col-2">
            <div class="row">
              ...
              <div class="col-12 q-mt-lg">
                <div class="text-grey">
                  <q-input label="강사명" filled dense v-model="managerName"
                           color="blue-grey-9" ref="managerName"/>
                </div>
              </div>
            </div>
          </div>
      ...
      <q-card-actions class="row items-center justify-end q-pa-sm">
        ...
        <q-btn color="blue-grey-8" class="btn-sm" @click="onClickChangeUser">
          일반회원 전환
        </q-btn>
...
export default {
  ...
  methods: {
    ...
    onClickSave() {
      console.log('저장');
      this.msg = '저장하시겠습니까?';
      this.confirmMethod = this.saveManager;
      this.isConfirm = true;
    },
